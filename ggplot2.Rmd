...
ggplot(TIME_SERIES_FV, aes(x=Week ,y =Cases_FV ))+
  geom_line(color='blue')+geom_point(size=2)
```
...
ggplot(Melt_Time_Series, aes(x=Week ,y =value,color=variable ))+geom_line()
```
...
ggplot(Melt_Time_Series , aes(x=Week ,y =value, color =variable ))+geom_line()+scale_color_manual(name="Counties",
                     labels=c("FV","I","CM",'HB'),
                     values=c("purple","green","navy",'gold'))+xlab("Time")+ylab("Cases")+ggtitle("Cases of TBA in California")
```
...
ggplot(Melt_Time_Series , aes(x=Week ,y =value, color =variable ))+geom_line()+scale_color_manual(name="Counties",
  ...
  ggtitle(("Time Series of TBA"))+theme_bw()
```
...
ggplot(subset(Melt_Time_Series,Melt_Time_Series$variable != 'Cases_FV'),
              aes(x=Week ,y =value, color =variable ))+geom_line()+ facet_wrap(~variable)+ 
  scale_color_manual(name="Counties",
                     labels=c("FV","I","CM",'HB'),
                     values=c("purple","green","navy",'gold'))
+xlab("week")+ylab("Cases")+ggtitle(("Time Series of TBA"))+theme_bw()
```
...
ggplot(age_2, aes(x = Age , y= value))
...
ggplot(age_2, aes(x = Age , y= value,)) + geom_bar(stat='identity')
```
...
ggplot(age_2, aes(x = Age , y= value, fill = variable)) + geom_bar(stat='identity',position='dodge')+
    scale_fill_manual(name="Counties",
                     labels=c("FV","I","CM",'HB'),
                     values=c("purple","green","navy",'gold'))+xlab("Age")+ylab("Cases")+ggtitle(("Cases by Age group"))+theme_bw()
```
...
ggplot(Melt_Cond_Series, aes(x = variable  , y= Conditions,fill = value))+geom_tile(color='green')+
...
ggplot(Melt_Cond_Series, aes(x = variable, y= Conditions, fill=value))+geom_tile(color="white")+
   scale_fill_manual(name = '',labels = c('Absent', "Present"), values = c("black",'green'))+theme_bw()
```
